...
static NSString *const BDHSendButtonTintNormalColor = @"#1FB823";
//static NSString *const BDHSendButtonTintAbnormalColor = @"#C9DCCA";
static NSString *const BDHSendButtonTintAbnormalColor = @"#C9EFCA";

static CGFloat const kSendButtonTextWitdh = 38.0f;

@interface BDHSendButton ()
...
- (void)setupViews
{
    ...
    _backGroudView.backgroundColor = [UIColor bdh_hexStringToColor:BDHSendButtonTintNormalColor];
    ...
    [_sendButton setTitle:NSLocalizedStringFromTable(@"send", @"BDHImagePicker", @"发送")
                 forState:UIControlStateNormal];
    [_sendButton setTitleColor:[UIColor bdh_hexStringToColor:BDHSendButtonTintNormalColor] forState:UIControlStateNormal];
    [_sendButton setTitleColor:[UIColor bdh_hexStringToColor:BDHSendButtonTintAbnormalColor] forState:UIControlStateHighlighted];
    [_sendButton setTitleColor:[UIColor bdh_hexStringToColor:BDHSendButtonTintAbnormalColor] forState:UIControlStateDisabled];

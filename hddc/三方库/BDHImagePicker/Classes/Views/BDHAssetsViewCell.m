...
#import "BDHImagePicker.h"

@interface BDHAssetsViewCell ()
...
@implementation BDHAssetsViewCell
...
- (void)fillWithAsset:(nonnull BDHAsset *)asset isSelected:(BOOL)seleted {
    ...
    if (self.asset) {
        [BDHImagePickerHelper cancelFetchWithAssets:self.asset];
    }
    self.asset = asset;
    ...
    [BDHImagePickerHelper fetchImageWithAsset:self.asset

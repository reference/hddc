...
@implementation YXFaultSvyPointModel

+ (void)saveWithBody:(YXFaultSvyPointModel *)body completion:(void(^)(NSError *error))completion
{
    NSString *url = [NSString stringWithFormat:@"%@/hddc/hddcWyFaultsvypoints", YX_HOST];
...
{
    NSString *url = [NSString stringWithFormat:@"%@/hddcAppForminfo/hddcWyFaultsvypoints/%@", YX_HOST,uuid];

//
//  UIViewController+BDHImagePicker.m
//  ImagePicker
//
...
@implementation UIViewController (BDHImagePicker)
- (void)createBarButtonItemAtPosition:(BDHImagePickerNavigationBarPosition)position statusNormalImage:(UIImage *)normalImage statusHighlightImage:(UIImage *)highlightImage action:(SEL)action {
    
    UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
    UIEdgeInsets insets = UIEdgeInsetsZero;
    switch (position) {
        case BDHImagePickerNavigationBarPositionLeft:
            insets = UIEdgeInsetsMake(0, -20, 0, 20);
            break;
        case BDHImagePickerNavigationBarPositionRight:
...
- (void)createBarButtonItemAtPosition:(BDHImagePickerNavigationBarPosition)position text:(NSString *)text action:(SEL)action {
    UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
    ...
    [button setTitleColor:[UIColor bdh_hexStringToColor:@"#808080"] forState:UIControlStateHighlighted];

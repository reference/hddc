...
@interface YXGeophySvyPointModel : NSObject
/**
 * 测点桩号
 */
//@Column(name="milestonenum")
@property (nonatomic, strong) NSString *milestonenum;
/**
 * 审查时间
 */
 ...
 * 测点描述
 */
//@Column(name="svypointdescription")
@property (nonatomic, strong) NSString *svypointdescription;
@property (nonatomic, strong) NSString *svypointdescriptionName;
/**
 * 任务名称
 */

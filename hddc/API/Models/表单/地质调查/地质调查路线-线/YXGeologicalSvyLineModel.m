...
@implementation YXGeologicalSvyLineModel

+ (void)saveWithBody:(YXGeologicalSvyLineModel *)body completion:(void(^)(NSError *error))completion
{
    NSString *url = [NSString stringWithFormat:@"%@/hddc/hddcWyGeologicalsvylines", YX_HOST];
...
{
    NSString *url = [NSString stringWithFormat:@"%@/hddcAppForminfo/hddcWyGeologicalsvylines/%@", YX_HOST,uuid];
